 ...
 */
public class SFormComponent extends SBeanForm {

    private SDbComponent moRegistry;

    /**
     * Creates new form SFormComponent
     * @param client
     * @param title
     */
    public SFormComponent(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.DU_CMP, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void reloadCatalogues() {
        ...
        miClient.getSession().populateCatalogue(moKeyType, SModConsts.DS_CMP_TP, SLibConsts.UNDEFINED, null);
    }

    @Override
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbComponent) registry;
        ...
        moKeyType.setValue(new int[] { moRegistry.getFkComponentTypeId() });
    ...
    @Override
    public SDbComponent getRegistry() throws Exception {
        SDbComponent registry = moRegistry.clone();
        ...
        registry.setFkComponentTypeId(moKeyType.getValue()[0]);
