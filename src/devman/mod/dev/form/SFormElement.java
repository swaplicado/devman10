 ...
 */
public class SFormElement extends SBeanForm {

    private SDbElement moRegistry;
     ...
     * @param title
     */
    public SFormElement(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.DU_ADE, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void reloadCatalogues() {
        ...
        miClient.getSession().populateCatalogue(moKeyType, SModConsts.DS_ADE_TP, SLibConsts.UNDEFINED, null);
    }

    @Override
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbElement) registry;
        ...
        moKeyType.setValue(new int[] { moRegistry.getFkElementTypeId() });
    ...
    @Override
    public SDbElement getRegistry() throws Exception {
        SDbElement registry = moRegistry.clone();
        ...
        registry.setFkElementTypeId(moKeyType.getValue()[0]);
