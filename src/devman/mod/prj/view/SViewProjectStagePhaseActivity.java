 ...
 */
public class SViewProjectStagePhaseActivity extends SGridPaneView {

    private SGridFilterPanelCompound moFilterProjectStage;

    public SViewProjectStagePhaseActivity(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.PU_PRJ_STG_PHS_ACT, SLibConsts.UNDEFINED, title);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "v.id_act AS " + SDbConsts.FIELD_ID + "4, "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.PU_PRJ_STG_PHS_ACT) + " AS v "
                ...
                + "v.id_prj = psp.id_prj AND v.id_stg = psp.id_stg AND v.id_phs = psp.id_phs "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.CU_USR) + " AS ui ON "
                + "v.fk_usr_ins = ui.id_usr "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.CU_USR) + " AS uu ON "
                + "v.fk_usr_upd = uu.id_usr "
                + "LEFT OUTER JOIN " + SModConsts.TablesMap.get(SModConsts.PU_PRJ_DLV) + " AS d ON "
                + "v.fk_dlv_prj_n = d.id_prj AND v.fk_dlv_dlv_n = d.id_dlv "
                + (sql.isEmpty() ? "" : "WHERE " + sql)
                + "ORDER BY p.code, ps.code, psp.code, v.code, v.name, v.id_prj, v.id_stg, v.id_phs, v.id_act ";
    }
    ...
    public ArrayList<SGridColumnView> createGridColumns() {
        ...
        columns.add(new SGridColumnView(SGridConsts.COL_TYPE_TEXT_CODE_ITM, "d.code", "Entregable"));
