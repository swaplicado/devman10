 ...
 */
public class SViewProjectDeliverable extends SGridPaneView {

    private SGridFilterPanel moFilterProject;

    public SViewProjectDeliverable(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.PU_PRJ_DLV, SLibConsts.UNDEFINED, title);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "v.id_dlv AS " + SDbConsts.FIELD_ID + "2, "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.PU_PRJ_DLV) + " AS v "
                ...
                + "ORDER BY p.code, v.name, v.code, v.id_prj, v.id_dlv ";
    }
