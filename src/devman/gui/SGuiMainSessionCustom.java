...
public class SGuiMainSessionCustom implements SGuiSessionCustom {
    ...
    protected int[] manProjectStageKey;
    ...
    public SGuiMainSessionCustom(SGuiClient client, int terminal) {
        mnTerminal = terminal;
        manProjectStageKey = new int[] { SLibConsts.UNDEFINED, SLibConsts.UNDEFINED };
    }

    public void setProjectStageKey(int[] key) { manProjectStageKey = key; }
    
    public int[] getProjectStageKey() { return manProjectStageKey; }
