...
public class SGridFilterPanelCompound extends JPanel implements SGridFilter, ActionListener, ItemListener {
     ...
     */
    public SGridFilterPanelCompound(SGuiClient client, SGridPaneView paneView, int type1, int type2) {
        miClient = client;
        moPaneView = paneView;
        mnFilterType1 = type1;
        mnFilterType2 = type2;
    ...
    public void updateOptions() {
        ...
        moFieldKeyGroup.addFieldKey(moKeyFilter1, mnFilterType1, SLibConsts.UNDEFINED, new SGuiParams(SDbRegistry.FIELD_CODE));
